...
python3 -m vseek.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3-4bt_vl_lvb-emreward-vllm-wtool-tagsummary' \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=10 \
    data.train_files=/nas/mars/dataset/longvideobench/window_8/tagsummary/train.parquet \
    data.val_files=/nas/mars/dataset/longvideobench/window_8/tagsummary/test.parquet \
