...
python3 -m vseek.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen25-3b_vl_lvb-emreward-sgl-wtool-openai' \
    trainer.n_gpus_per_node=5 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=5 \
    data.train_files=/nas/mars/dataset/longvideobench/window_16/train_openai.parquet \
    data.val_files=/nas/mars/dataset/longvideobench/window_16/test_openai.parquet \
